...
final class PinPanel {
    ...
    private static void drawBody(
            GuiGraphicsExtractor guiGraphics, PinnedRecipe pin, int x, int y, int mouseX, int mouseY) {
        var pose = guiGraphics.pose();
        pose.pushMatrix();
        pose.translate(x, y);
        pose.scale((float) pin.scale(), (float) pin.scale());
    ...
    private static void drawGrip(GuiGraphicsExtractor guiGraphics, int right, int bottom, int color) {
