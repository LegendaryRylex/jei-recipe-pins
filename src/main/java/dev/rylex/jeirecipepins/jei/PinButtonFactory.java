...
final class PinButtonFactory implements IRecipeButtonControllerFactory {
    private static final Identifier ICON = JeiRecipePins.id("textures/gui/pin.png");
    private static final Identifier PINNED_ICON = JeiRecipePins.id("textures/gui/pin_active.png");
